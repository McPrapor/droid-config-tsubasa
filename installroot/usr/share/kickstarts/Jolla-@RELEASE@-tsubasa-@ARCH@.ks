# DisplayName: Jolla tsubasa/@ARCH@ (release) 1
...
repo --name=adaptation0-tsubasa-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-sony-tsubasa/@ARCH@/
...
%packages
@Jolla Configuration tsubasa
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/tsubasa
